...
PARAM  <- list()
PARAM$experimento <- "FE7310EF19"

PARAM$exp_input  <- "DR7210EF19"
...
PARAM$RandomForest$semilla  <- 700577    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 700577   # cambiar por la propia semilla
