...
PARAM  <- list()
PARAM$experimento <- "FE7310EF07"

PARAM$exp_input  <- "DR7210EF07"
...
PARAM$RandomForest$semilla  <- 700571    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 700571   # cambiar por la propia semilla
