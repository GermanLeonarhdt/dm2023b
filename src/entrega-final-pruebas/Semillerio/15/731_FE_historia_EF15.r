...
PARAM  <- list()
PARAM$experimento <- "FE7310EF15"

PARAM$exp_input  <- "DR7210EF15"
...
PARAM$RandomForest$semilla  <- 700573    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 700573   # cambiar por la propia semilla
