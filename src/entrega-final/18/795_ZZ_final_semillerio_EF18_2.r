...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950EF18_2"
PARAM$exp_input  <- "HT7510EF18"
...
PARAM$semillerio  <- 300   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
PARAM$semilla_primos  <- 600517  # se utiliza para generar el vector de  PARAM$semillerio  semillas
