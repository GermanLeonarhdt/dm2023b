...
PARAM$trainingstrategy$semilla_azar <- 700571 # Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar <- 700573
#------------------------------------------------------------------------------
...
hs <- makeParamSet(
  ...
  makeNumericParam("min_gain_to_split", lower = 0.00, upper = 15.0),
